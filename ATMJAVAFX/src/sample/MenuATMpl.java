...
public class MenuATMpl implements Initializable {
    ...
    public void handleButtonAction(ActionEvent event) {
        ...
        if (event.getSource() == cancelButtonMenu){
            ...
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("depositpl.fxml"));
            ...
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("balancepl.fxml"));
                Scene scene = new Scene(fxmlLoader.load(), 560, 420);
                Stage stage = (Stage) ((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
            ...
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("withdrawPL.fxml"));
                Scene scene = new Scene(fxmlLoader.load(), 560, 420);
                Stage stage = (Stage) ((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
            ...
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("blikPl.fxml"));
                Scene scene = new Scene(fxmlLoader.load(), 560, 420);
                Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
                stage.setScene(scene);
                stage.setTitle("Blik");
