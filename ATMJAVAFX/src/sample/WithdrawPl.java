...
public class WithdrawPl extends Account implements Initializable {
    ...
    private void handleButtonAction(ActionEvent event) {
        ...
        if (event.getSource() == twentyButton) {
            ...
            {
                this.a += ammount;
                actionLabel.setText("Operacja przebiegła pomyślnie." + "Twoje saldo:" + actualBalance);
            ...
            if ( a >= ammount && ammount % 50 == 0 || ammount % 100 == 0 || ammount % 20 == 0) {
                ...
                actionLabel.setText("Nie masz wystarczająco pieniedzy lub chcesz wyplacić gotówke!" + " " + " Możesz wypłacić " + a);
            }
